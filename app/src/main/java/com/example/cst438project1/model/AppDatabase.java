...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public void loadData(Context context) {
        List<Assignment> assignmentList = AppDatabase.getAppDatabase(context).getAssignmentDAO().getAllAssignments();
        List<Grade> gradeList = AppDatabase.getAppDatabase(context).getGradeDAO().getAllGrades();
